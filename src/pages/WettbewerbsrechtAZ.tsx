...
const WettbewerbsrechtAZ = () => {
  const entries = [
    {
      letter: "E",
      title: "Ist eine E-Mail-Werbung zulässig",
      path: "/wettbewerbsrecht/ist-eine-e-mail-werbung-zulaessig/"
    },
    {
      letter: "U",
      title: "Ungewünschte Werbenachrichten",
      path: "/wettbewerbsrecht/werbenachrichten/"
    }
  ];
...
export default WettbewerbsrechtAZ;