...
const VerwaltungsrechtAZ = () => {
  const entries = [
    {
      letter: "B",
      title: "Bescheid mit Zwangsgeldandrohung",
      path: "/verwaltungsrecht/zwangsgeldandrohung/"
    },
    {
      letter: "E",
      title: "Einrichtungsbezogene Impfpflicht und ihre Folgen",
      path: "/verwaltungsrecht/impfpflicht/"
    }
  ];
...
export default VerwaltungsrechtAZ;