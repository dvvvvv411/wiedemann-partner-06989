...
const MaklerrechtAZ = () => {
  const entries = [
    {
      letter: "I",
      title: "Informationen für Makler",
      path: "/maklerrecht/rechtliche-informationen-fuer-makler/"
    },
    {
      letter: "P", 
      title: "Probleme mit dem Makler",
      path: "/maklerrecht/probleme-mit-dem-makler-immobilien-versicherungsvertrag/"
    }
  ];
