...
const GrundstuecksrechtAZ = () => {
  const entries = [
    { letter: "N", title: "Nachgenehmigung beim Grundstückskauf", path: "/grundstuecksrecht/nachgenehmigung/" },
    { letter: "U", title: "Unberechtigte Parkplatznutzung", path: "/grundstuecksrecht/unberechtigte-parkplatznutzung/" },
  ];
      ...
      <section className="bg-[#004595] text-white py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="flex items-center text-blue-200 mb-6 text-sm">
            ...
            <ChevronRight className="w-4 h-4 mx-2" />
            <span className="text-white">Grundstücksrecht von A-Z</span>
          </div>
...
export default GrundstuecksrechtAZ;