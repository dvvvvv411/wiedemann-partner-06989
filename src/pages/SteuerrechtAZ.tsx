...
const SteuerrechtAZ = () => {
  const entries = [
    {
      letter: "A",
      title: "Anzeigepflicht Erbschaftsteuer",
      path: "/steuerrecht/anzeigepflicht-bei-erbschaft/"
    },
    {
      letter: "G", 
      title: "Gestaltungsmissbrauch nach § 42 AO",
      path: "/steuerrecht/gestaltungsmissbrauch/"
    },
    {
      letter: "S", 
      title: "Steuerstrafverfahren",
      path: "/steuerrecht/steuerstrafverfahren/"
    },
    {
      letter: "W", 
      title: "Wegzugsbesteuerung",
      path: "/steuerrecht/Wegzugsbesteuerung/"
    }
  ];
