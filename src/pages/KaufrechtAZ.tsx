...
const KaufrechtAZ = () => {
  const entries = [
    {
      letter: "A",
      title: "Autokauf und Gewährleistung",
      path: "/kaufrecht/autokauf-und-gewaehrleistung/"
    },
    {
      letter: "I", 
      title: "Internetversandhandel",
      path: "/kaufrecht/internetversandhandel/"
    }
  ];
